"""
pymlkit._api — Public-facing API functions.
...
def train(
    ...
    **kwargs: Any,
    ...
    --------
    >>> import pymlkit
    >>> model = pymlkit.train("titanic.csv", target="Survived")
    >>> model.evaluate()
...
def auto_train(
    ...
    *,
    ...
    --------
    >>> import pymlkit
    >>> model = pymlkit.auto_train("data.csv", time_budget=60)
...
def load_model(path: Union[str, Path]) -> "TrainedModel":
    """
    Load a previously saved pymlkit model.
    ...
    Examples
    --------
    >>> model = pymlkit.load_model("./my_model")
